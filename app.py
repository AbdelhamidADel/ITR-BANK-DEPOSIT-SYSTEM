...
st.set_page_config(layout="centered",page_icon=im,initial_sidebar_state="expanded",page_title="ITR-Bank System")
...
if selected =='Home':
    ...
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Day: last contact day of the month (1,2,3,....29,30) </p>", unsafe_allow_html=True)
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Duration: last contact duration, in seconds </p>", unsafe_allow_html=True)
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Campaign: number of contacts performed during this campaign and for this client </p>", unsafe_allow_html=True)
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Pdays: number of days that passed by after the client was last contacted from a previous campaign </p>", unsafe_allow_html=True)
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Previous: number of contacts performed before this campaign and for this client </p>", unsafe_allow_html=True)
    st.markdown("<p style='color: #262730;font-weight: bold; '>🟣 Poutcome: outcome of the previous marketing campaign (failure, nonexistent, success) </p>", unsafe_allow_html=True)
